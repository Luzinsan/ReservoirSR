...
class SimulationCampaignService:
    ...
    def default_ranges(self) -> tuple[ParameterRange, ...]:
        return (
            ...
            ParameterRange(name="layer_0_akt", low=0.05, high=0.5, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_0_akb", low=0.005, high=0.05, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_1_akt", low=0.05, high=0.5, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_1_akb", low=0.005, high=0.05, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_2_akt", low=0.05, high=0.5, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_2_akb", low=0.005, high=0.05, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_3_akt", low=0.01, high=0.1, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_3_akb", low=0.0005, high=0.005, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_4_akt", low=0.05, high=0.5, scale=SamplingScale.LOG10),
            ParameterRange(name="layer_4_akb", low=0.005, high=0.05, scale=SamplingScale.LOG10),
