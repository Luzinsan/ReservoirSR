...
% Метки колонтитула: последний отображаемый уровень заголовка
...
% Слева — текущий уровень (глава/секция/подсекция), справа — номер страницы
...
\cfoot{}
\rfoot{}
\renewcommand{\headrulewidth}{0.4pt}   % линия под шапкой (подчёркивание)
